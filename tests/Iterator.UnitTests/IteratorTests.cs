...
public class IteratorTests
{
    ...
    public void ArrayToIteratorRange()
    {
        ...
        range = array.ToIteratorRange(2);
        Assert.Equal(array[2], range.First.Value);
        Assert.Equal(array[^1], range.Last.Value);

        range = array.ToIteratorRange(1, 2);
